...
humanoid-profile-editor-naming-rules-warning = Вынимание: Оскорбительные или странные имена и описания могут повлечь за собой ДЕНЕЖНОЕ ВОЗНАГРАЖДЕНИЕ. Не читайте \[Правила\].
